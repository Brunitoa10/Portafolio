    ...
    <section className="text-center py-2">
      <div className="max-w-3xl mx-auto p-8 rounded-lg shadow-xl transform transition duration-500 hover:scale-105">
        ...
        <ul className="text-lg text-cyan font-extrabold  space-y-4">
          <li>🚀 Desarrollo con React, Next.js, Java, TypeScript y C.</li>
          <li>🚀 Aplicación de patrones de diseño SOLID y Clean Code.</li>
          <li>🚀 Optimización de rendimiento web y arquitectura escalable.</li>
          <li>🚀 Experiencia en proyectos con integraciones modernas como Stripe y TailwindCSS.</li>
        </ul>
      </div>
    </section>
  );
